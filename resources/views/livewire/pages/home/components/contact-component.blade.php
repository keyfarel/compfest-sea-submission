    ...
    <div class="container mx-auto px-6">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start">
            <div class="space-y-6">
                ...
                <p class="text-base text-gray-600 leading-relaxed">Have questions or special requests? Our team is here
                    to help you with anything you need.</p>
                <ul class="space-y-4 pt-4">
                    <li class="flex items-center gap-4">
                        ...
                        <span class="text-gray-700">08123456789</span>
                    </li>
                    <li class="flex items-center gap-4">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                             stroke="currentColor" class="w-6 h-6 text-green-600">
                        ...
                        <span class="text-gray-700">Monday - Friday: 8am - 8pm</span>
                    </li>
                    <li class="flex items-center gap-4">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                             stroke="currentColor" class="w-6 h-6 text-green-600">
                ...
                <p class="pt-4 text-sm text-gray-500">
                    Manager: <span class="font-medium">Brian</span>
                </p>
            </div>
            <div class="bg-white p-8 rounded-lg shadow-lg border border-gray-100">
                <form action="#" method="POST" class="space-y-6">
                    ...
                    <div>
                        <button type="submit"
                                class="w-full btn btn-primary bg-green-600 hover:bg-green-700 border-none text-white font-semibold py-3 px-4 rounded-lg transition duration-300">
                            Send Message
                        </button>
                    </div>
                </form>
