<div class="space-y-4">
    ...
    <div>
        ...
        <input type="text" id="fullName" wire:model.defer="fullName"
               readonly
               class="mt-1 block w-full bg-gray-100 cursor-not-allowed border border-gray-300 rounded-md shadow-sm focus:outline-none py-2 px-4"
    ...
    <div x-data="{ phone: '' }">
        ...
        <div class="text-xs text-gray-500 mt-1" x-text="phone.length + ' / 20 digit'"></div>
