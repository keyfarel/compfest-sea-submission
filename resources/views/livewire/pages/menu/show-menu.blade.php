<div class="relative">
    ...
    <div wire:loading.class.delay="opacity-50"
        ...
        @forelse($plansToShow as $plan)
            @include('livewire.pages.menu.components.show-menu._meal-card-component', ['plan' => $plan])
        @empty
    ...
    @if($selectedPlan)
        @include('livewire.pages.menu.components.show-menu._modal-component', ['title' => 'Detail Plan'])
    @endif
